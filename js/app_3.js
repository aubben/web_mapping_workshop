...
featureLayer.on('ready', function(){
  this.eachLayer(function(layer){
    layer.bindPopup(layer.feature.properties.name+'<br>'+layer.feature.properties.cuisine+'<br>'+layer.feature.properties.opening_hours+'<br>'+layer.feature.properties.website);
  });
});
